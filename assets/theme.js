...
import { timeline } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate, timeline as timeline2, stagger } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { stagger as stagger2 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate as animate2, stagger as stagger3, inView } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { inView as inView2 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { timeline as timeline3, inView as inView3 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate as animate3 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate as animate4 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { Delegate as Delegate2 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
var FreeShippingBar = class extends HTMLElement {
  ...
  _updateMessage() {
    ...
    const shippingCostElement = document.getElementById("shoppingCost");
    if (this.totalPrice >= this.threshold) {
      messageElement.innerHTML = this.getAttribute("reached-message");
      if(shippingCostElement) {
        shippingCostElement.innerText = "kostenlos";
      }
    } else {
      const replacement = `<span class="bold text-accent-bar">${formatMoney(this.threshold - this.totalPrice).replace(/\$/g, "$$$$")}</span>`;
      messageElement.innerHTML = this.getAttribute("unreached-message").replace(new RegExp("({{.*}})", "g"), replacement);
      if(shippingCostElement) {
        shippingCostElement.innerText = "4,90 €";
      }
    }
  }
...
import { animate as animate5 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { Delegate as Delegate3 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
var ProductForm = class extends HTMLFormElement {
  ...
  async _onSubmit(event) {
    ...
    /* Custom Code um den Socken Mengen Rabatt zu ermöglichen 
    const option1Value = formData.get('option1');
    const option2Value = formData.get('option2');
    const option3Value = formData.get('option3');
    const hasPaarOption = 
      (option1Value && option1Value.includes('spare')) || 
      (option2Value && option2Value.includes('spare')) || 
      (option3Value && option3Value.includes('spare'));
    if (hasPaarOption) {
      try {
        if (typeof window.mengenrabatt === 'function') {
            const manipulatedFormData = await window.mengenrabatt(formData);
            
            if (!manipulatedFormData) {
            await new Promise(resolve => setTimeout(resolve, 100));
            }
          if (manipulatedFormData && manipulatedFormData.id) {
            formData.set('id', manipulatedFormData.id.toString());
            formData.set('option2', '1 Paar');
            formData.delete('quantity');
            formData.append('quantity', manipulatedFormData.quantity.toString());
          }
        } else {
          console.warn('mengenrabatt function not found in global scope');
        }
      } catch (error) {
        console.error('Error applying mengenrabatt:', error);
      }
    }
    /* Custom Code Ende */
...
import { PhotoSwipeLightbox } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//www.patronsocks.com/cdn/shop/t/26/assets/photoswipe.min.js?v=20290624223189769891785339229"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { inView as inView4 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
    ...
    if (this.hasAttribute("show-play-button") && !this.shadowRoot) {
      this.attachShadow({ mode: "open" }).appendChild(document.createRange().createContextualFragment(`
        ...
        <svg part="play-button" fill="none" width="48" height="48" viewBox="0 0 48 48">
          <path d="M48 24C48 10.745 37.255 0 24 0S0 10.745 0 24s10.745 24 24 24 24-10.745 24-24Z" fill="#efefef"/>
...
import { timeline as timeline6 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate as animate8 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate as animate9 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
import { animate as animate10, inView as inView5 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
...
// js/theme.js
import { Delegate as Delegate4 } from "//www.patronsocks.com/cdn/shop/t/26/assets/vendor.min.js?v=52426788336887041471785339229";
(() => {
